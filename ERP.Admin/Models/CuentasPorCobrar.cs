...
namespace ERP.Admin.Models
{
    ...
    {
        [Display(Name = "id_cuentas_por_cobrar")]
        [JsonProperty("id_cuentas_por_cobrar")]
        public int id_cuentas_por_cobrar { get; set; }

        [Display(Name = "fk_comprobante_venta_cobro")]
        [JsonProperty("fk_comprobante_venta_cobro")]
        public int fk_comprobante_venta_cobro { get; set; }
        ...
        public int fk_cliente_natural { get; set; }
        public int fk_cliente_juridico { get; set; }

        public DateTime f_pago { get; set; }
        public decimal saldo_pago { get; set; }
