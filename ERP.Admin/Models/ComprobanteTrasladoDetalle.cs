...
{
    public class ComprobanteTrasladoDetalle
    {
        [Display(Name = "id_comprobante_traslado_detalle")]
        [JsonProperty("id_comprobante_traslado_detalle")]
        public int id_comprobante_traslado_detalle { get; set; }

        [Display(Name = "fk_comprobante_traslado")]
        [JsonProperty("fk_comprobante_traslado")]
        public int fk_comprobante_traslado { get; set; }

        [Display(Name = "fk_solicitud_traslado_detalle")]
        [JsonProperty("fk_solicitud_traslado_detalle")]
        public int fk_solicitud_traslado_detalle { get; set; }
        ...
        [Display(Name = "cantidad_solicitada")]
        [JsonProperty("cantidad_solicitada")]
        public decimal cantidad_solicitada { get; set; }

        [Display(Name = "cantidad_atendida")]
        [JsonProperty("cantidad_atendida")]
        public decimal cantidad_atendida { get; set; }

        [Display(Name = "estado_solicitud_traslado_detalle")]
        [JsonProperty("estado_solicitud_traslado_detalle")]
        public string estado_solicitud_traslado_detalle { get; set; }
