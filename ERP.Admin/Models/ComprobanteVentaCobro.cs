...
{
    public class ComprobanteVentaCobro
    {
        [Display(Name = "id_comprobante_venta_cobro")]
        [JsonProperty("id_comprobante_venta_cobro")]
        public int id_comprobante_venta_cobro { get; set; }
        ...
        [Display(Name = "flg_cronograma_comprobante_venta")]
        [JsonProperty("flg_cronograma_comprobante_venta")]
        public string flg_cronograma_comprobante_venta { get; set; }
